...
local Window = WindUI:CreateWindow({
    ...
    Author = "By ZorVex",
    Folder = "ZorVex_" .. tostring(os.clock()),
...
ImgBtn.MouseButton1Click:Connect(function()
    local shrink = TweenService:Create(ImgBtn, TweenInfo.new(0.1), {Size = UDim2.new(0, 60, 0, 60)})
    local grow = TweenService:Create(ImgBtn, TweenInfo.new(0.1), {Size = UDim2.new(0, 70, 0, 70)})
    shrink:Play()
...
WindUI:Notify({
    ...
    Content = "Halo " .. displayName .. " Key System Active",
    Duration = 5
})
...
WindUI:Notify({
    Title = "ZorVex Hub Loaded",
    Content = "Halo " .. player.DisplayName .. " Free Features Done",
    Duration = 5
})
...
teleportTab:Dropdown({
    ...
    Values = {"Area Spawn", "Area Frost", "Area Mythical", "Area Inferno", "Area Jungle", "Void Brawl", "Desert Brawl", "Ori Brawl"},
    Callback = function(v)
        currentVersion = v
        RefreshButtons()
    end
